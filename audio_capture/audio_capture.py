...
class AudioCapture:
    def __init__(self, buffer_size=4096, frames_per_buffer=1024):
        ...
        log16 = np.log(buffer_size) / np.log(16)
        if not check_power_16(buffer_size):
            print(f"Warning: Buffer size {buffer_size} is not a power of 16")
